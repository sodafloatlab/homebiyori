  ...
  const handleEmotionSend = (emoji: string, label: string) => {
    ...
    setTimeout(() => {
      const emotionResponses = {
        '嬉しい': {
          mittyan: 'その笑顔が見えるようです。嬉しい気持ち、大切にしてくださいね。',
          madokasan: 'わあ！嬉しそうですね！私も一緒に嬉しいです！',
          hideji: 'ほほほ、その嬉しそうな顔が目に浮かぶわい。'
        },
        '悲しい': {
          mittyan: '悲しい時は無理をしないでくださいね。あなたの気持ち、わかりますよ。',
          madokasan: '大丈夫ですか？悲しい時は一人で抱え込まないでくださいね。',
          hideji: '悲しい時もあるさ。それも人生の一部じゃ。'
        },
        '困った': {
          mittyan: '困ったことがあるのですね。一緒に考えましょう。きっと解決策が見つかりますよ。',
          madokasan: '困ったときは一人で抱え込まないでくださいね。何か手伝えることがあるかもしれません！',
          hideji: '困ったときは知恵を絞ることじゃ。わしの経験も役に立つかもしれんぞ。'
        }
      };
                      ...
                      {msg.sender === 'ai' && (
                        <div className="flex items-end space-x-2 max-w-[80%]">
                          <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0">
                            <Image
                              src={AI_CHARACTERS[msg.aiRole!]?.image || '/images/icons/mittyan.png'}
