...
# notification_serviceパッケージを強制的に作成
notification_service_package = types.ModuleType('notification_service')
notification_service_package.__path__ = [current_dir]
sys.modules['notification_service'] = notification_service_package

# 相対インポートが動作するようにmainモジュールを読み込み
spec = importlib.util.spec_from_file_location("notification_service.main", os.path.join(current_dir, "main.py"))
main_module = importlib.util.module_from_spec(spec)
sys.modules['notification_service.main'] = main_module
