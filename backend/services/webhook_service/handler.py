"""
Lambda Handler for Webhook Service
...
@maintenance_required(skip_paths=["/health", "/webhook/health"])
async def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    """
    try:
        logger.info("Webhook service invoked", extra={
        ...
        logger.debug("Webhook service response", extra={
            "request_id": context.aws_request_id,
        ...
        logger.error("Fatal error in webhook handler", extra={
            "error": str(e),
