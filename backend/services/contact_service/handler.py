...
# contact_serviceパッケージを強制的に作成
contact_service_package = types.ModuleType('contact_service')
contact_service_package.__path__ = [current_dir]
sys.modules['contact_service'] = contact_service_package

# 相対インポートが動作するようにmainモジュールを読み込み
spec = importlib.util.spec_from_file_location("contact_service.main", os.path.join(current_dir, "main.py"))
main_module = importlib.util.module_from_spec(spec)
sys.modules['contact_service.main'] = main_module
