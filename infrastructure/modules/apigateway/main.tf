...
# Gateway Response for CORS on 401 Unauthorized (認証エラー時のCORS対応)
...
# Gateway Response for CORS on 500 Internal Server Error
...
# Gateway Response for CORS on 400 Bad Request
