...
const ChatScreen = ({ 
  ...
  const generateFruitMessage = (emotion: string, aiRole: AiRole): string => {
    const fruitMessages = {
      tama: {
        '疲れ': 'あなたが今感じている疲れ、それもとても大切なものですね。そんな正直な気持ちが光る実になりました。',
        '嬉しい': 'その喜びが伝わってきました。あなたの嬉しさが、こうして実として形になってくれたのですね。',
        '大変': 'いろいろと大変なことがあるのですね。でも、そうやって向き合うあなたの姿が実になりました。',
        '愛情': 'あなたの温かい愛情が、こんなに美しい実を育ててくれました。素敵ですね。',
        '不安': '不安になることだってありますよね。その素直な気持ちも、ちゃんと実として残してくれました。'
      },
      madoka: {
        '疲れ': 'お疲れ様！そんな時こそ素直な気持ちを話してくれて、それが実になったんですね！',
        '嬉しい': 'わあ！その嬉しい気持ちが光る実になりました！私も一緒に嬉しいです！',
        '大変': '大変な時でも頑張っているあなたの気持ち、ちゃんと実として形になりましたよ！',
        '愛情': 'その愛情たっぷりな気持ち、実になって残ってくれました！素晴らしいです！',
        '不安': '不安な気持ちも大事にしてくれてありがとう。それも立派な実になりました！'
      },
      hide: {
        '疲れ': 'ふむふむ、疲れを感じる時もあるものじゃ。そんな時の素直さが、実として残ったのじゃな。',
        '嬉しい': 'その嬉しい気持ち、よく分かるぞ。それが実を結んだのは、自然なことじゃ。',
        '大変': '人生には大変なこともあるものじゃ。それでも頑張るあなたの心が、実になったのじゃよ。',
        '愛情': 'その愛情深い心、わしにもよく伝わってくる。それが実として形になったのじゃ。',
        '不安': '不安を感じることも、人として当たり前のことじゃ。その気持ちが実になったのじゃな。'
      }
    };
    
    const messages = fruitMessages[aiRole];
    return messages[emotion as keyof typeof messages] || `今の会話で感じた気持ちが、光る実として残りました。`;
  };
