...
const FAQPage = ({ onNavigate, onClose }: FAQPageProps) => {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'はい、無料版でもほめびよりの全ての基本機能をご利用いただけます。チャット履歴は3日間保存され、ほめの実の記録は永続的に残ります。プレミアム版では、ディープモード、グループチャット、チャット履歴の無制限保存が追加されます。',
      keywords: ['無料', '無料版', 'チャット履歴', '3日間', 'ほめの実', '永続']
    },
    {
      id: 'usage-2',
      category: 'usage',
    ...
    // プレミアム機能関連
    {
      ...
      answer: 'ディープモード（より深い会話）、グループチャット機能（複数のAIキャラクターとの同時会話）、チャット履歴の無制限保存が利用できます。無料版でも基本機能はすべて使用可能で、チャット履歴は3日間保存されます。',
      keywords: ['プレミアム', '特典', 'ディープモード', 'グループチャット', 'チャット履歴', '無制限']
    },
    {
      id: 'premium-2',
      category: 'premium',
