...
jest.mock('@/lib/services/api/ChatAPIService', () => ({
  ChatAPIService: jest.fn(),
}));

jest.mock('@/lib/services/api/TreeAPIService', () => ({
  TreeAPIService: jest.fn(),
}));
...
// API Services are now class-based, so we'll mock them differently in individual tests
